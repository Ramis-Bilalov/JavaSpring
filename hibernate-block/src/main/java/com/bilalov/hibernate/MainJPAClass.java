...
public class MainJPAClass {
    public static void main(String[] args) {
        ...
        Catalog catalog1 = new Catalog("Horrors #1");
        Catalog catalog2 = new Catalog("Horrors #2");
        Catalog catalog3 = new Catalog("Horrors #3");
        Catalog catalog4 = new Catalog("Horrors #4");
        ...
        try {
            ...
            em.getTransaction().begin();
            Catalog catalog6 = em
                    .createQuery("SELECT c from Catalog c WHERE c.id = ?1", Catalog.class)
                    .setParameter(1, 3L)
                    .getSingleResult();
